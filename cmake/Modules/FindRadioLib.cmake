...
if (APPLE)
    find_path(Radiolib_HOME_DIR NAMES library.json
            HINTS ${RADIOLIB_HOME_DIR}
            PATHS ${RADIOLIB_HOME_DIR}
    )

    find_path(Radiolib_SOURCE_DIR NAMES RadioLib.h
...
if (NOT Radiolib_VERSION AND EXISTS "${Radiolib_HOME_DIR}/library.json")
    file(STRINGS "${Radiolib_HOME_DIR}/library.json" RADIOLIV_VERSION_LINE REGEX "\"version\":")
